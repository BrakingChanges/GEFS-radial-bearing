...
export enum DestinationName {
    PerthIntl = "PERTH INTL",
}

export interface DestinationNotam {
    source_id:                SourceID;
    account_id:               PurpleAccountID;
    notam_id:                 string;
    location_id:              FirDest;
    location_icao:            FirDest;
    ...
    notam_qcode_subject:      NotamQcode;
    notam_qcode_status:       NotamQcode;
    notam_is_obstacle:        boolean;
}

export enum PurpleAccountID {
    Pnc = "PNC",
    Ybbbzezx = "YBBBZEZX",
}

export type DateExpire = boolean | Date;
...
export enum NotamNrc {
    Notamn = "NOTAMN",
    Notamr = "NOTAMR",
}

export type NotamQcode = any[] | string;
...
export enum OriginName {
    BandaranaikeIntlColombo = "BANDARANAIKE INTL COLOMBO",
    HalimPerdanakusuma = "HALIM PERDANAKUSUMA",
    Heathrow = "HEATHROW",
}

export interface OriginNotam {
    source_id:                SourceID;
    account_id:               FluffyAccountID;
    notam_id:                 string;
    location_id:              FirDest;
    location_icao:            FirDest;
